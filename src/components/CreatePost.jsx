    ...
    return (
        <>
            <div className="createpost">
                ...
                <textarea type="text" placeholder="Write something here" id="postCap" onChange={handleChange} value={caption} />
                <label htmlFor="postImg" className="inputLabel">Click here to add an image</label>
